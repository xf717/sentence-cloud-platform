//package com.db.chaomaxs.system.errorcode.config;
//
...
//
//@ConfigurationProperties("chaomaxs.error-code")
//@Validated
...
//     * 应用分组
//     */
//    @NotNull(message = "应用分组不能为空，请设置 chaomaxs.error-code.group 配置项，推荐直接使用 spring. application.name 配置项")
