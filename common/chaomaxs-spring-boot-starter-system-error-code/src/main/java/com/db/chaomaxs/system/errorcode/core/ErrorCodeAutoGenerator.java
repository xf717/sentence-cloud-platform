...
//import com.db.chaomaxs.systemservice.rpc.errorcode.dto.ErrorCodeAutoGenerateDTO;
...
//            logger.info("[execute][未配置 chaomaxs.error-code.constants-class 配置项，不进行自动写入到 system-service 服务]");
//            return;
//        }
