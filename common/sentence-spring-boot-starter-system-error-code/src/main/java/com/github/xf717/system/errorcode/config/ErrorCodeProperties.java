//package com.github.xf717.system.errorcode.config;
//
...
//
//@ConfigurationProperties("sentence.error-code")
//@Validated
...
//     * 应用分组
//     */
//    @NotNull(message = "应用分组不能为空，请设置 sentence.error-code.group 配置项，推荐直接使用 spring. application.name 配置项")
