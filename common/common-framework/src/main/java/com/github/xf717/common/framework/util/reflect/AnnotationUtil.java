...
public final class AnnotationUtil {
  ...
  private static <A extends Annotation> void getSuperAnnotations(Class<A> annotationType,
   ...
   */
  public static <T extends Annotation> Set<Method> getAnnotatedPublicMethods(Class<?> clazz,
      Class<T> annotation) {
    ...
    for (Method method : methods) {
      ...
      if (method.getAnnotation(annotation) != null || searchOnInterfaces(method, annotation,
          ifcs)) {
