...
import com.github.xf717.common.framework.util.io.URLResourceUtil;
import com.github.xf717.common.framework.util.number.NumberUtil;
...
public class PropertiesUtil {
  ...
  public static Properties loadFromFile(String generalPath) {
    ...
    try (Reader reader = new InputStreamReader(URLResourceUtil.asStream(generalPath),
        Charsets.UTF_8)) {
      p.load(reader);
    } catch (IOException e) {
