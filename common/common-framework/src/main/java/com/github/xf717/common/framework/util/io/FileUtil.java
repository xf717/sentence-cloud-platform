package com.github.xf717.common.framework.util.io;

import com.github.xf717.common.framework.util.base.Platforms;
...
import com.github.xf717.common.framework.util.text.Charsets;
...
public class FileUtil {
  ...
  public static void moveDir(@NotNull File from, @NotNull File to) throws IOException {
    ...
    if (!rename) {
      ...
      if (from.exists()) {
        throw new IOException(
            "Failed to delete original directory '" + from + "' after copy to '" + to + '\'');
      }
    }
  }
