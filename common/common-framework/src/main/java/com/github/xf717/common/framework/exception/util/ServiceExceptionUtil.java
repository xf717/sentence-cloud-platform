package com.github.xf717.common.framework.exception.util;
 ...
 * <p>
 * 目的在于，格式化异常信息提示。 考虑到 String.format 在参数不正确时会报错，因此使用 {} 作为占位符，并使用 {@link #doFormat(int, String,
 * Object...)} 方法来格式化
 * <p>
 * 因为 {@link #MESSAGES} 里面默认是没有异常信息提示的模板的，所以需要使用方自己初始化进去。目前想到的有几种方式：
 * <p>
 * 1. 异常提示信息，写在枚举类中，例如说，com.github.xf717.user.api.constants.ErrorCodeEnum 类 +
