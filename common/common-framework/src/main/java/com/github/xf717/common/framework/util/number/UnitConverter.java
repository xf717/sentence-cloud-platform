 ...
 */
package com.github.xf717.common.framework.util.number;
 ...
 * 将带单位的时间，大小字符串转换为数字.
 * <p>
 * from Facebook https://github.com/facebook/jcommon/blob/master/config/src/main/java/com/facebook/config/ConfigUtil.java
 *
 * @author xiaofeng
 */
