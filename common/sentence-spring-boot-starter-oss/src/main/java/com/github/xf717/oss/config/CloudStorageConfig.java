package com.github.xf717.oss.config;
...
public class CloudStorageConfig implements Serializable {
  ...
  public String toString() {
    return new ToStringBuilder(this)
        .append("type", type)
        .append("qiniuDomain", qiniuDomain)
        .append("qiniuPrefix", qiniuPrefix)
        .append("qiniuAccessKey", qiniuAccessKey)
        .append("qiniuSecretKey", qiniuSecretKey)
        .append("qiniuBucketName", qiniuBucketName)
        .append("aliyunDomain", aliyunDomain)
        .append("aliyunPrefix", aliyunPrefix)
        .append("aliyunEndPoint", aliyunEndPoint)
        .append("aliyunAccessKeyId", aliyunAccessKeyId)
        .append("aliyunAccessKeySecret", aliyunAccessKeySecret)
        .append("aliyunBucketName", aliyunBucketName)
        .append("qcloudDomain", qcloudDomain)
        .append("qcloudPrefix", qcloudPrefix)
        .append("qcloudAppId", qcloudAppId)
        .append("qcloudSecretId", qcloudSecretId)
        .append("qcloudSecretKey", qcloudSecretKey)
        .append("qcloudBucketName", qcloudBucketName)
        .append("qcloudRegion", qcloudRegion)
        .toString();
  }
}
