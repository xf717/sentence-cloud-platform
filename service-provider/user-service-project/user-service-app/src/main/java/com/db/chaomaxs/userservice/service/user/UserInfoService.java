...
import com.db.chaomaxs.userservice.convert.user.UserInfoConvert;
...
import com.db.chaomaxs.userservice.dal.mysql.dataobject.user.UserPersonalInfoDO;
...
public class UserInfoService {
  ...
  private String genNickname(String nickname) {
    if (!StringUtils.hasText(nickname)) {
      // 默认初始化一个昵称
      nickname =
          "chaomaxs_" + StringUtils.generateRandomCode(5);
    }
    return nickname;
  }
