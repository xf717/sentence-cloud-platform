...
import com.github.xf717.userservice.enums.user.RegisterTypeEnum;
...
public class UserThirdService {
  ...
  private UserInfoDO buildUserInfo(String nickname, String mobile) {
    if (StringUtils.isEmpty(nickname)) {
      // 默认初始化一个昵称
      nickname =
          "sentence_" + com.github.xf717.common.framework.util.StringUtils.generateRandomCode(5);
    }
    UserInfoDO userInfoDO = new UserInfoDO()
        .setNickname(nickname)
        //第三方登录密码默认为随机码
        .setPassword(com.github.xf717.common.framework.util.StringUtils.uuid(true))
        // 通过手机号码进行绑定
        .setMobile(mobile)
  ...
  private UserExtendDO buildUserExtend(String ip, Long userId, Integer gender) {
    ...
    UserExtendDO userExtend = new UserExtendDO()
        ...
        .setGender(gender)
        .setRealName("")
        .setIdcard(com.github.xf717.common.framework.util.StringUtils.generateRandomCode(18))
        .setCompanyName("")
