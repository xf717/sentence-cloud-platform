package com.db.chaomaxs.managementweb.controller.position.dto;
...
@ApiModel(value = "ManagementPositionPageDTO",description = "分页:企业_职位")
public class ManagementPositionPageDTO extends PageParam {


	private static final long serialVersionUID = -6979118040595356446L;
	/**
	 * 系统id
	 */
