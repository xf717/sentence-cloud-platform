...
@ApiModel(value = "BaseGroupTypePageDTO", description = "分页:")
public class BaseGroupTypePageDTO extends PageParam {

  private static final long serialVersionUID = 362585689371572076L;
  /**
   *
   */
