...
@ApiModel(value = "PositionKeywordPageDTO",description = "分页:内容管理-职位关键词信息表")
public class PositionKeywordPageDTO extends PageParam {

	private static final long serialVersionUID = -1311582520852680098L;
	/**
	 * 系统id
	 */
