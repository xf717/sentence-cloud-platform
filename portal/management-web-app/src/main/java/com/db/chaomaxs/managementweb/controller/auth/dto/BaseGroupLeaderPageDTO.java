...
@ApiModel(value = "BaseGroupLeaderPageDTO", description = "分页:")
public class BaseGroupLeaderPageDTO extends PageParam {

  private static final long serialVersionUID = -5776892696156978800L;
  /**
   *
   */
   ...
   *
   */
  @ApiModelProperty(name = "updHost", value = "")
