...
@ApiModel(value = "WorkContentExtendPageDTO",description = "分页:内容管理-工作内容_扩展信息表")
public class WorkContentExtendPageDTO extends PageParam {

	private static final long serialVersionUID = 214997832246386583L;
	/**
	 * 系统id
	 */
