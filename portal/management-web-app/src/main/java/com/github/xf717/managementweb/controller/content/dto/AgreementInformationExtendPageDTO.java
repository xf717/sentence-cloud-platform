...
@ApiModel(value = "AgreementInformationExtendPageDTO",description = "分页:内容管理-协议信息_扩展息表")
public class AgreementInformationExtendPageDTO extends PageParam {

	private static final long serialVersionUID = 1443907517647802373L;
	/**
	 * 系统id
	 */
