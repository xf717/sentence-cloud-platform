...
@ApiModel(value = "PositionKeywordExtendPageDTO",description = "分页:职务关键词-扩展信息表")
public class PositionKeywordExtendPageDTO extends PageParam {

	private static final long serialVersionUID = -3194671720811691963L;
	/**
	 * 系统id
	 */
