...
@ApiModel(value = "ReleasePlatformPageDTO",description = "分页:发布平台")
public class ReleasePlatformPageDTO extends PageParam {

	private static final long serialVersionUID = 532530871895455142L;
	/**
	 * 系统id
	 */
