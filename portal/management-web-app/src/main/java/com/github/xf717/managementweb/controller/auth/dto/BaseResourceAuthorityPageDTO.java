...
@ApiModel(value = "BaseResourceAuthorityPageDTO", description = "分页:")
public class BaseResourceAuthorityPageDTO extends PageParam {

  private static final long serialVersionUID = 1187628934993506612L;
  /**
   *
   */
