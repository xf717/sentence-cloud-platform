...
@ApiModel(value = "ProblemInformationExtendPageDTO",description = "分页:内容管理-问题扩展信息表")
public class ProblemInformationExtendPageDTO extends PageParam {

	private static final long serialVersionUID = 595488910012084667L;
	/**
	 * 系统id
	 */
