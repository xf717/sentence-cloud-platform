...
@ApiModel(value = "NoticeInformationPageDTO",description = "分页:通知信息表")
public class NoticeInformationPageDTO extends PageParam {

	private static final long serialVersionUID = -8810985964660731849L;
	/**
	 * 系统id
	 */
