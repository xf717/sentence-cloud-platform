...
@ApiModel(value = "FeedbackPageDTO", description = "分页:帮助与反馈")
public class FeedbackPageDTO extends PageParam {

  private static final long serialVersionUID = 8596301125232987293L;
  /**
   * 系统id
   */
