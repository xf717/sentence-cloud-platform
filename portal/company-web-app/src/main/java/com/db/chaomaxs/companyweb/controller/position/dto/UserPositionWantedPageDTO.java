...
@ApiModel(value = "UserPositionWantedPageDTO",description = "分页:用户求职")
public class UserPositionWantedPageDTO extends PageParam {

	private static final long serialVersionUID = 7574349274773107159L;
	/**
	 * 系统id
	 */
