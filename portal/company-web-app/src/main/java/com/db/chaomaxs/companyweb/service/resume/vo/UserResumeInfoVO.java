package com.db.chaomaxs.companyweb.service.resume.vo;
...
@ApiModel(value = "UserBaseInfoVO", description = "用户信息")
public class UserResumeInfoVO implements Serializable {
