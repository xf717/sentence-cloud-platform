...
@ApiModel(value = "PositionTypePageDTO",description = "分页:职务职位分类信息表")
public class PositionTypePageDTO extends PageParam {


	private static final long serialVersionUID = -8479363369335069278L;
	/**
	 * 分类名称
	 */
