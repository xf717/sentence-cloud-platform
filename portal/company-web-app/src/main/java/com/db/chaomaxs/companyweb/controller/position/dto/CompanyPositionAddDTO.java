...
@ApiModel(value = "CompanyPositionCreateDTO", description = "添加企业_职位")
public class CompanyPositionAddDTO {
     ...
     * 职位关键字
     */
    @ApiModelProperty(name = "KeywordIds", value = "职位关键字id")
    ...
    @ApiModelProperty(name ="education", value = "学历要求：冗余字段")
