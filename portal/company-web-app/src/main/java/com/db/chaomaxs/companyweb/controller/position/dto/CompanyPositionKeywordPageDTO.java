...
@ApiModel(value = "CompanyPositionKeywordPageDTO",description = "分页:企业_职位")
public class CompanyPositionKeywordPageDTO extends PageParam {

	private static final long serialVersionUID = -5910013493989754925L;
	/**
	 * 系统id
	 */
