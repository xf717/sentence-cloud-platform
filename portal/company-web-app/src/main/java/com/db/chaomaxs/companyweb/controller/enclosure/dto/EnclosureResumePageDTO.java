...
@ApiModel(value = "EnclosureResumePageDTO", description = "分页:企业附件简历")
public class EnclosureResumePageDTO extends PageParam {

  private static final long serialVersionUID = -8333369954999627760L;
  /**
   *
   */
