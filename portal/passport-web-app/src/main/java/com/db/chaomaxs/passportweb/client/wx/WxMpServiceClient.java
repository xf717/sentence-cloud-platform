package com.db.chaomaxs.passportweb.client.wx;
...
//    final String url = "http://chaomaxs.xxxxxxxx/wx/oauth2";
//    try {
//      // 第一步
//      final String redirectUri = "http://chaomaxs.xxx.com/wxloginCallback";
//
